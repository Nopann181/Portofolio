...
- Projects: Sport4All, PDAM Smart Management, Sports App Wireflow; each has role, description, and tool. Sport4All includes a four-screen carousel, PDAM includes a five-screen carousel, and Sports App Wireflow retains a replaceable visual placeholder.
...
## Media
The uploaded recording remains the primary visual reference. The Hero uses the uploaded portrait photo with a stable chest-up crop. Sport4All uses four screenshots and PDAM uses five screenshots in accessible arrow/dot carousels with circular touch swipe. All three project visual areas are approximately 25% more compact than the original MVP. Sports App Wireflow remains an intentional placeholder until its assets are provided.